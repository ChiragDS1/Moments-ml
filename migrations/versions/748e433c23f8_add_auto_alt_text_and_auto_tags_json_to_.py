"""add auto_alt_text and auto_tags_json to Photo

Revision ID: 748e433c23f8
Revises: 
Create Date: 2025-09-18 11:55:37.608230
...
def upgrade():
    ...
    sa.Column('auto_alt_text', sa.String(length=160), nullable=True),
    sa.Column('auto_tags_json', sa.Text(), nullable=True),
